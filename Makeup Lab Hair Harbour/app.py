...
def pipeline(model, image, video, color):
    if image is not None:
        ...
        st.info('Memory is limited in the streamlit, so we only generate the first 3 seconds of your video!')
...
# ================================================================================================
st.title('Makeup Lab Tool for Hair Harbour 🧑‍🔬💄')
st.markdown(
    'By Edunet Foundation - 2024', unsafe_allow_html=True)
